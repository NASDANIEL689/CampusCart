            ...
            <div className="grid gap-6">
              {menuItems.map((item, i) => (
                <motion.div 
                  ...
                  className="group bg-white p-6 rounded-[2.5rem] border border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-8 hover:shadow-2xl hover:shadow-brand-500/5 transition-all duration-500"
                >
                  <div className="flex flex-col sm:flex-row gap-8 items-center flex-1">
                    <div className="relative">
                      <img 
                        ...
                        alt="" 
                        className="w-32 h-32 rounded-3xl object-cover group-hover:scale-110 transition-transform duration-700" 
                        referrerPolicy="no-referrer" 
                      />
                    ...
                    <div className="text-center sm:text-left space-y-2">
                      <h3 className="font-display font-black text-2xl text-slate-900 group-hover:text-brand-600 transition-colors">{item.name}</h3>
                      <p className="text-slate-500 font-medium line-clamp-2 max-w-md">{item.description}</p>
                      <div className="flex items-center justify-center sm:justify-start gap-4 pt-2">
                        <span className="text-2xl font-display font-black text-brand-600">BWP {item.price}</span>
                  ...
                  <button 
                    ...
                    className="w-full sm:w-auto bg-slate-900 text-white px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-brand-600 hover:-translate-y-1 transition-all duration-300 shadow-xl shadow-slate-900/10 hover:shadow-brand-500/20"
                  >
                    Add to Order
                  </button>
                </motion.div>
